	...
	*/
	public function get_form_defaults() {
		return [ 
				...
				'form_title' => __( 'Edit Site', 'frontend-admin' ),
				'submit' => __( 'Update', 'frontend-admin' ),
				'success_message' => __( 'Your site info has been updated successfully.', 'frontend-admin' ),
	...
	public function get_title() {
		return __( 'Site Options Form', 'frontend-admin' );
	}
