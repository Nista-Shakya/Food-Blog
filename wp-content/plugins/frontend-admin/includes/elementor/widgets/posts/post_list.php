...
class Post_List_Widget extends Widget_Base{
	...
	public function get_title() {
		return __( 'Post List', 'frontend-admin' );
	}
	...
	protected function register_layout_section_controls() {
		...
		$this->add_control(
			'posts_per_page',
			[
				'label' => __( 'Posts Per Page', 'frontend-admin' ),
		...
		$post_data_options = [
			...
			'post' => [
				...
				'options' => [
					'post content'  => __( 'Post Body', 'frontend-admin' ),
				],
			],			
			'custom' => [
        ...
        $repeater->add_control(
			'post_data',
			[
				'label' => __( 'Post Data', 'frontend-admin' ),
		...
		$this->add_control(
			'post_margin',
			[
				'label' => __( 'Post Margin', 'frontend-admin' ),
				'type' => Controls_Manager::DIMENSIONS,
				'size_units' => ['px', '%', 'em'],
				'default' => [
					'top' => 'o',
		...
		$this->add_control(
			'post_space',
			[
				'label' => __( 'Post Spacing', 'frontend-admin' ),
				'type' => Controls_Manager::SLIDER,
				'default' => [
					'size' => 20,
				],
		...
		$this->add_control(
			'post_padding',
			[
				'label' => __( 'Post Paddings', 'frontend-admin' ),
				'type' => Controls_Manager::DIMENSIONS,
				'size_units' => ['px', '%', 'em'],
				'default' => [
					'top' => '20',
		...
		$this->add_control(
			'post_border_radius',
			[
				'label' => __( 'Post Border Radius', 'frontend-admin' ),
				'type' => Controls_Manager::DIMENSIONS,
				'size_units' => ['px', '%', 'em'],
				'default' => [
					'top' => 'o',
