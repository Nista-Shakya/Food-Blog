...
class Post_Status_Widget extends Widget_Base
{
    ...
    {
        return __( 'Post Status Button', 'frontend-admin' );
    }
    ...
    protected function _register_controls()
    {
        ...
        $this->add_control( 'dynamic', [
            'label'       => __( 'Dynamic Selection', 'frontend-admin' ),
            'type'        => Controls_Manager::SELECT2,
            'label_block' => true,
    ...
    protected function render()
    {
        ...
        if ( $display ) {
			...
			<button onclick="return confirm(\'' . $settings['confirm_delete_message'] . '\')" type="submit" class="button fafe-delete-button">' ;
