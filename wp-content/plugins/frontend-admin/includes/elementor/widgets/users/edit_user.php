	...
	*/
	public function get_form_defaults() {
		return [ 
				...
				'form_title' => __( 'Edit Profile', 'frontend-admin' ),
				'submit' => __( 'Update', 'frontend-admin' ),
				'success_message' => __( 'Your profile has been updated successfully.', 'frontend-admin' ),
				'field_type' => 'username',
				'fields' => [
					[
						'field_type' => 'username',
	...
	public function get_title() {
		return __( 'User Edit Form', 'frontend-admin' );
	}
