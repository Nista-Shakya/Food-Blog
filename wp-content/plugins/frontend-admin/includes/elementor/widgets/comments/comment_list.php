...
class Comments_List_Widget extends Widget_Base{
	...
	public function get_title() {
		return __( 'Comment List', 'frontend-admin' );
	}
	...
	protected function register_layout_section_controls() {
		...
		$this->add_control(
			'comments_per_page',
			[
				'label' => __( 'Comments Per Page', 'frontend-admin' ),
		...
		$comment_data_options = [
			'user' => [
				'label' => __( 'Author', 'frontend-admin' ),
				'options' => [
					'display name'  => __( 'Display Name', 'frontend-admin' ),
					'user email'  => __( 'Author Email', 'frontend-admin' ),
					'first name' => __( 'First Name', 'frontend-admin' ),
					'last name' => __( 'Last Name', 'frontend-admin' ),
					'profile image'  => __( 'Profile Image', 'frontend-admin' ),
				],
			],			
			'comment' => [
				'label' => __( 'Comment', 'frontend-admin' ),
				'options' => [
					'comment content'  => __( 'Comment Body', 'frontend-admin' ),
				],
			],			
			'custom' => [
				'label' => __( 'Custom', 'frontend-admin' ),
				'options' => [
					'custom'  => __( 'Custom', 'frontend-admin' ),
					'custom field'  => __( 'Custom Field Data', 'frontend-admin' ),
				],
			],
			'layout' => [
				'label' => __( 'Layout', 'frontend-admin' ),
				'options' => [
					'group'  => __( 'Group', 'frontend-admin' ),
				],
			],
		];
        ...
        $repeater->add_control(
			'comment_data',
			[
				'label' => __( 'Comment Data', 'frontend-admin' ),
		...
		$repeater->add_control(
			...
			[
				...
				'options' => [
					'text'  => __( 'Text', 'frontend-admin' ),
					'image' => __( 'Image', 'frontend-admin' ),
					'choices' => __( 'Choices', 'frontend-admin' ),
                ],
                'condition' => [ 
		...
		$repeater->add_control(
			'custom_text', [
				...
				'default' => __( 'Some Custom Text' , 'frontend-admin' ),
                'condition' => [
                    'comment_data' => 'custom',
					'data_type' => 'text',
				],	
		...
		$repeater->add_control(
			'custom_field_source',
			[
				'label' => __( 'Source', 'frontend-admin' ),
				'type' => \Elementor\Controls_Manager::SELECT,
				'default' => 'comment',
				'options' => [
					'comment'  => __( 'Comment', 'frontend-admin' ),
        ...
        $repeater->add_control(
			'comment_custom_text',
			[
				'label' => __( 'Field Key', 'frontend-admin' ),
				'type' => \Elementor\Controls_Manager::SELECT,
				'options' => fafe_get_field_data( 'text' ),
				'required' => 'true',
                'condition' => [ 
					'comment_data' => 'custom field', 
		...
		$repeater->add_control(
			...
			[
				'label' => __( 'Field Key', 'frontend-admin' ),
				'type' => \Elementor\Controls_Manager::SELECT,
				'options' => fafe_get_field_data( ['radio', 'select', 'button_group'] ),
				'required' => 'true',
                'condition' => [ 
					'comment_data' => 'custom field', 
		...
		$repeater->add_control(
			'comment_before_text',
			[
				'label' => __( 'Before Text', 'frontend-admin' ),
				'type' => \Elementor\Controls_Manager::TEXT,
				'conditions' => [
					'relation' => 'or',
		...
		$repeater->add_control(
			'comment_after_text',
			[
				'label' => __( 'After Text', 'frontend-admin' ),
				'type' => \Elementor\Controls_Manager::TEXT,
				'conditions' => [
					'relation' => 'or',
					'terms' => $text_based_fields,
		...
		$repeater->add_control(
			...
			[
				'label' => __( 'Default Text', 'frontend-admin' ),
				'type' => \Elementor\Controls_Manager::TEXT,
				'conditions' => [
					'relation' => 'or',
					'terms' => $text_based_fields,
		...
		$repeater->add_control(
			...
			[
				'label' => __( 'Field Key', 'frontend-admin' ),
				'type' => \Elementor\Controls_Manager::SELECT,
				'options' => fafe_get_field_data( 'image' ),
				'required' => 'true',
                'condition' => [ 
					'comment_data' => 'custom field',
		...
		$repeater->add_control(
			'default_image', [
                'label' => __( 'Default Image' , 'frontend-admin' ),
				'type' => \Elementor\Controls_Manager::MEDIA,
				'default' => [
					'url' => \Elementor\Utils::get_placeholder_image_src(),
                ],
		...
		$repeater->add_control(
			'image_alt', [
				...
				'type' => \Elementor\Controls_Manager::SELECT,
				'default' => __( 'display_name' , 'frontend-admin' ),
				'options' => [
					'display name'  => __( 'Author Display Name', 'frontend-admin' ),
					'first name' => __( 'Author First Name', 'frontend-admin' ),
					'last name' => __( 'Author Last Name', 'frontend-admin' ),
				],
                'condition' => [
                    'comment_data' => 'profile image',
                ],	
		...
		$repeater->start_controls_tab(
			...
			[
				'label' => __( 'Advanced', 'frontend-admin' ),
			]
		);
		$repeater->add_responsive_control(
			'block_width',
		...
		$repeater->add_control(
			'block_padding',
			[
				'label' => __( 'Padding', 'frontend-admin' ),
				'type' => Controls_Manager::DIMENSIONS,
				'size_units' => ['px', '%', 'em'],
				'default' => [
					'top' => 'o',
		...
		$repeater->add_control(
			'block_margin',
			[
				'label' => __( 'Margin', 'frontend-admin' ),
				'type' => Controls_Manager::DIMENSIONS,
				'size_units' => ['px', '%', 'em'],
				'default' => [
					'top' => '20',
		...
		$this->add_control(
			'comment_list_data',
			[
				'label' => __( 'User Data', 'frontend-admin' ),
		...
		$this->add_control(
			'comment_margin',
			[
				'label' => __( 'Comment Margin', 'frontend-admin' ),
				'type' => Controls_Manager::DIMENSIONS,
				'size_units' => ['px', '%', 'em'],
				'default' => [
					'top' => 'o',
		...
		$this->add_control(
			'comment_space',
			[
				'label' => __( 'Comment Spacing', 'frontend-admin' ),
				'type' => Controls_Manager::SLIDER,
				'default' => [
					'size' => 20,
				],
		...
		$this->add_control(
			'reply_space',
			[
				'label' => __( 'Reply Spacing', 'frontend-admin' ),
				'type' => Controls_Manager::SLIDER,
				'default' => [
					'size' => 20,
				],
		...
		$this->add_control(
			'comment_padding',
			[
				'label' => __( 'Comment Paddings', 'frontend-admin' ),
				'type' => Controls_Manager::DIMENSIONS,
				'size_units' => ['px', '%', 'em'],
				'default' => [
					'top' => '20',
		...
		$this->add_control(
			...
			[
				'label' => __( 'Comment Border Radius', 'frontend-admin' ),
				'type' => Controls_Manager::DIMENSIONS,
				'size_units' => ['px', '%', 'em'],
				'default' => [
					'top' => 'o',
		...
		foreach( $settings['comment_list_data'] as $index => $comment_data ){	
			...
			if( $block_data == 'group' ){
				...
				switch ( $block_data ) {
					case 'profile_image':
						$type = 'image';
						$alt_text = __( 'Profile Image', 'frontend-admin' );
