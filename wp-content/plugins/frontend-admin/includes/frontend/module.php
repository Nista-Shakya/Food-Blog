...
if ( !class_exists( 'FrontendAdmin_Hooks' ) ) {
    class FrontendAdmin_Hooks
    {
        public function load_fafe_dynamic_settings( $field )
        {
        ...
        public function fafe_load_text_field( $field )
        {
        ...
        public function fafe_load_gallery_field( $field )
        {
        ...
        public function fafe_upload_image_field( $field )
        {
        ...
        public function fafe_upload_images_field( $field )
        {
            $uploader = acf_get_setting( 'uploader' );
            // enqueue
            if ( $uploader == 'basic' || !empty($field['button_text']) ) {
        ...
        public function fafe_load_relationship_field( $field )
        {
        ...
        public function fafe_load_taxonomy_field( $field )
        {
            global  $post ;
        ...
        public function fafe_load_display_name_field( $field )
        {
        ...
        public function fafe_edit_password_field( $field )
        {
            if ( !$field['value'] || !$this->fafe_is_custom( $field ) ) {
                return $field;
            }
        ...
        public function fafe_date_time_field( $field )
        {
        ...
        public function fafe_username_disabled( $field )
        {
        ...
        public function fafe_repeater_row_author( $field )
        {
        ...
        public function fafe_frontend_setting( $field )
        {
        ...
        public function fafe_price_field( $field )
        {
            acf_render_field_setting( $field, array(
        ...
        public function fafe_true_false_field( $field )
        {
            acf_render_field_setting( $field, array(
        ...
        public function fafe_filter_relationship_field( $field )
        {
            $users = get_users();
        ...
        public function fafe_add_edit_field( $field )
        {
            acf_render_field_setting( $field, array(
        ...
        public function fafe_title_field( $field )
        {
            acf_render_field_setting( $field, array(
                'label'        => __( 'Read only' ),
        ...
        public function fafe_password_field( $field )
        {
            acf_render_field_setting( $field, array(
        ...
        public function hide_fafe_fields( $groups )
        {
            unset( $groups['fafe-hidden'] );
            return $groups;
        }
        
        public function fafe_email_field( $field )
        {
            acf_render_field_setting( $field, array(
                'label'        => __( 'User Email' ),
        ...
        public function fafe_content_field( $field )
        {
            acf_render_field_setting( $field, array(
        ...
        public function fafe_excerpt_field( $field )
        {
            acf_render_field_setting( $field, array(
        ...
        public function fafe_file_folders_setting( $field )
        {
            acf_render_field_setting( $field, array(
                ...
                'layout'        => 'horizontal',
                'default_value' => 'all',
                'choices'       => fafe_get_image_folders(),
            ) );
        }
        
        public function fafe_gallery_field( $field )
        {
            acf_render_field_setting( $field, array(
                'label'       => __( 'Button Text' ),
                'name'        => 'button_text',
                'type'        => 'text',
                'placeholder' => __( 'Add Images', 'frontend-admin' ),
            ) );
            /* acf_render_field_setting( $field, array(
        ...
        public function fafe_image_field( $field )
        {
            acf_render_field_setting( $field, array(
                'label'       => __( 'Button Text' ),
                'name'        => 'button_text',
        ...
        public function fafe_repeater_field( $field )
        {
            acf_render_field_setting( $field, array(
                'label'        => __( 'Limit Row Edit to', 'frontend-admin' ),
                'instructions' => '',
                'type'         => 'select',
                'name'         => 'filter_row_edit',
                'instructions' => __( 'Save data to the rows and filter the rows based on that data. Brought to you by Frontend Admin.', 'frontend-admin' ),
                'choices'      => [
                'author' => __( 'Author of the Row', 'frontend-admin' ),
            ],
                'multiple'     => 1,
                'ui'           => 1,
                'allow_null'   => 1,
        ...
        private function fafe_is_custom( $field )
        {
        ...
        public function fafe_load_text_value( $value, $post_id = false, $field = false )
        {
            if ( !$this->fafe_is_custom( $field ) ) {
                return $value;
            }
            if ( $post_id ) {
        ...
        public function fafe_load_password_value( $value, $post_id = false, $field = false )
        {
            if ( !$this->fafe_is_custom( $field ) ) {
                return $value;
            }
        ...
        public function fafe_load_email_value( $value, $post_id = false, $field = false )
        {
            if ( !$this->fafe_is_custom( $field ) ) {
                return $value;
            }
        ...
        public function fafe_load_textarea_value( $value, $post_id = false, $field = false )
        {
            if ( !$this->fafe_is_custom( $field ) ) {
                return $value;
            }
        ...
        public function fafe_load_wysiwyg_value( $value, $post_id = false, $field = false )
        {
            if ( !$this->fafe_is_custom( $field ) ) {
                return $value;
            }
        ...
        public function fafe_load_image_value( $value, $post_id = false, $field = false )
        {
            if ( !$this->fafe_is_custom( $field ) ) {
                return $value;
            }
        ...
        public function fafe_load_taxonomy_value( $value, $post_id = false, $field = false )
        {
        ...
        public function fafe_load_number_value( $value, $post_id = false, $field = false )
        {
            if ( !$this->fafe_is_custom( $field ) ) {
                return $value;
            }
        ...
        public function fafe_load_truefalse_value( $value, $post_id = false, $field = false )
        {
            if ( !$this->fafe_is_custom( $field ) ) {
                return $value;
            }
        ...
        public function fafe_load_gallery_value( $value, $post_id = false, $field = false )
        {
            if ( !$this->fafe_is_custom( $field ) ) {
                return $value;
            }
        ...
        public function fafe_load_choice_value( $value, $post_id = false, $field = false )
        {
            if ( !$this->fafe_is_custom( $field ) ) {
                return $value;
            }
        ...
        public function fafe_load_user_value( $value, $post_id = false, $field = false )
        {
            if ( !$this->fafe_is_custom( $field ) ) {
                return $value;
            }
        ...
        public function fafe_load_date_time_value( $value, $post_id = false, $field = false )
        {
            if ( !$this->fafe_is_custom( $field ) ) {
                return $value;
            }
        ...
        public function fafe_edit_post_button(
            $title,
            $post,
            $field,
            $post_id
        ...
        public function fafe_add_post_button( $field )
        {
        ...
        public function fafe_ajax_add_form()
        {
            // vars
            ...
            if ( !$edit_post ) {
                ...
                if ( isset( $post_type_choices ) ) {
                    ...
                    $form_args['fields'][] = 'fafe_post_type';
                }
        ...
        public function fafe_relationship_query( $args, $field, $post_id )
        {
        ...
        public function fafe_before_repeater_field( $field )
        {
        ...
        public function fafe_after_repeater_field( $field )
        {
            if ( empty($field['filter_row_edit']) || is_admin() ) {
                return;
            }
        ...
        public function update_fafe_values( $value, $post_id = false, $field = false )
        {
        ...
        public function fafe_update_text_value( $value, $post_id = false, $field = false )
        {
            if ( !$this->fafe_is_custom( $field ) ) {
                return $value;
            }
            ...
            if ( is_numeric( $post_id ) ) {
                ...
                if ( !isset( $_POST['fafe_registered_user'] ) ) {
        ...
        public function fafe_update_password_value( $value, $post_id = false, $field = false )
        {
            if ( !$this->fafe_is_custom( $field ) ) {
                return $value;
            }
        ...
        public function fafe_update_email_value( $value, $post_id = false, $field = false )
        {
            if ( !$this->fafe_is_custom( $field ) ) {
                return $value;
            }
        ...
        public function fafe_update_textarea_value( $value, $post_id = false, $field = false )
        {
            if ( !$this->fafe_is_custom( $field ) ) {
                return $value;
            }
            ...
            if ( is_numeric( $post_id ) ) {
                ...
                remove_filter(
                    ...
                    [ $this, 'fafe_update_textarea_value' ],
                    9,
                    3
                );
                wp_update_post( $post_to_edit );
        ...
        public function fafe_update_wysiwyg_value( $value, $post_id = false, $field = false )
        {
            if ( !$this->fafe_is_custom( $field ) ) {
                return $value;
            }
            ...
            if ( is_numeric( $post_id ) ) {
                ...
                remove_filter(
                    ...
                    [ $this, 'fafe_update_wysiwyg_value' ],
                    9,
                    3
                );
                wp_update_post( $post_to_edit );
        ...
        public function fafe_update_attachment_value( $value, $post_id = false, $field = false )
        {
            ...
            if ( is_numeric( $post_id ) ) {
                remove_filter(
                    ...
                    [ $this, 'fafe_update_attachment_value' ],
                    8,
                    3
                );
        ...
        public function fafe_update_image_value( $value, $post_id = false, $field = false )
        {
            if ( !$this->fafe_is_custom( $field ) ) {
                return $value;
            }
        ...
        public function fafe_update_number_value( $value, $post_id = false, $field = false )
        {
            if ( !$this->fafe_is_custom( $field ) ) {
                return $value;
            }
        ...
        public function fafe_update_truefalse_value( $value, $post_id = false, $field = false )
        {
            if ( !$this->fafe_is_custom( $field ) ) {
                return $value;
            }
        ...
        public function fafe_update_gallery_value( $value, $post_id = false, $field = false )
        {
            if ( !$this->fafe_is_custom( $field ) ) {
                return $value;
            }
        ...
        public function fafe_update_choice_value( $value, $post_id = false, $field = false )
        {
            if ( !$this->fafe_is_custom( $field ) ) {
                return $value;
            }
        ...
        public function fafe_update_user_value( $value, $post_id = false, $field = false )
        {
            if ( !$this->fafe_is_custom( $field ) ) {
                return $value;
            }
        ...
        public function fafe_update_date_time_value( $value, $post_id = false, $field = false )
        {
            if ( !$this->fafe_is_custom( $field ) ) {
                return $value;
            }
        ...
        public function fafe_update_repeater_value( $value, $post_id = false, $field = false )
        {
            if ( empty($field['filter_row_edit']) || is_admin() ) {
                return $value;
            }
            ...
            if ( !empty($value) ) {
                ...
                for ( $i = 0 ;  $i < $old_value ;  $i++ ) {
                    ...
                    if ( !empty($value[$new_value]) && (!$row_author || $row_author == $value[$new_value]['fafe_row_author']) && $row_author != 'user_0' ) {
        ...
        public function fafe_after_save_post( $post_id )
        {
            if ( !isset( $_POST['acf'] ) ) {
                return $post_id;
            }
            ...
            if ( is_numeric( $post_id ) ) {
                ...
                if ( isset( $form['user_manager'] ) ) {
                    update_user_meta( $user_id, 'fafe_manager', $form['user_manager'] );
                }
        ...
        public function fafe_exclude_groups( $field_group )
        {
            
            if ( !isset( $field_group['fafe_group'] ) ) {
                return $field_group;
            } elseif ( is_admin() ) {
                ...
                if ( function_exists( 'get_current_screen' ) ) {
                    ...
                    if ( isset( $current_screen->post_type ) && $current_screen->post_type == 'fafe_payment' ) {
                        return $field_group;
                    } elseif ( isset( $current_screen->id ) && $current_screen->id == $fafe_settings ) {
                        return $field_group;
                    } else {
                        return [];
                    }
        ...
        public function fafe_validation()
        {
        ...
        public function fafe_pass_validation()
        {
            if ( isset( $_POST['_acf_status'] ) && $_POST['_acf_status'] != 'publish' ) {
        ...
        public function fafe_validate_useremail(
            $is_valid,
            $value,
            $field,
            $input
        ...
        public function fafe_validate_term_name(
            $is_valid,
            $value,
            $field,
            $input
        ...
        public function fafe_validate_username(
            $is_valid,
            $value,
            $field,
            $input
        )
        {
            ...
            if ( isset( $field['custom_username'] ) && $field['custom_username'] == 1 ) {
                ...
                if ( isset( $taken ) ) {
                    return __( 'The username ' . $value . ' is taken. Please try a different username', 'frontend-admin' );
                }
        ...
        public function fafe_validate_password(
            $is_valid,
            $value,
            $field,
            $input
        ...
        public function fafe_render_text_field( $field )
        {
            if ( isset( $field['custom_username'] ) && $field['custom_username'] == 1 ) {
        ...
        public function fafe_render_password_field( $field )
        {
            wp_enqueue_script( 'password-strength-meter' );
            wp_enqueue_script( 'fafe-password-strength' );
        ...
        public function fafe_render_email_field( $field )
        {
            if ( isset( $field['custom_email'] ) && $field['custom_email'] == 1 ) {
        ...
        public function fafe_render_select_field( $field )
        {
            if ( isset( $field['custom_user_role'] ) && $field['custom_user_role'] == 1 ) {
        ...
        public function fafe_fields_enqueue_scripts()
        {
            wp_enqueue_style( 'fafe-forms' );
            wp_enqueue_style( 'fafe-modal' );
            wp_enqueue_script( 'fafe-forms' );
            wp_enqueue_script( 'fafe-modal' );
        ...
        public function __construct()
        {
            ...
            add_action( 'acf/enqueue_scripts', [ $this, 'fafe_fields_enqueue_scripts' ] );
            add_filter( 'acf/load_field/type=radio', [ $this, 'fafe_load_display_name_field' ] );
            add_filter( 'acf/load_field/type=relationship', [ $this, 'fafe_load_relationship_field' ] );
            add_filter( 'acf/load_field/type=taxonomy', [ $this, 'fafe_load_taxonomy_field' ] );
            add_filter( 'acf/prepare_field/type=text', [ $this, 'fafe_load_text_field' ] );
            add_filter( 'acf/prepare_field/type=gallery', [ $this, 'fafe_load_gallery_field' ] );
            add_filter( 'acf/prepare_field/type=image', [ $this, 'fafe_upload_image_field' ] );
            add_filter( 'acf/prepare_field/type=gallery', [ $this, 'fafe_upload_images_field' ] );
            add_filter( 'acf/prepare_field/type=password', [ $this, 'fafe_edit_password_field' ] );
            add_filter( 'acf/prepare_field/type=date_time_picker', [ $this, 'fafe_date_time_field' ] );
            add_filter( 'acf/prepare_field', [ $this, 'load_fafe_dynamic_settings' ], 3 );
            add_filter( 'acf/prepare_field', [ $this, 'fafe_username_disabled' ] );
            //add_filter( 'acf/load_field',  [ $this, 'fafe_repeater_row_author'] );
            //Add field settings by type
            add_action( 'acf/render_field_settings', [ $this, 'fafe_frontend_setting' ] );
            add_action( 'acf/render_field_settings/type=text', [ $this, 'fafe_title_field' ] );
            //add_action( 'acf/render_field_settings/type=post_object',  [ $this, 'fafe_add_edit_field'] );
            add_action( 'acf/render_field_settings/type=relationship', [ $this, 'fafe_add_edit_field' ] );
            add_action( 'acf/render_field_settings/type=relationship', [ $this, 'fafe_filter_relationship_field' ], 1 );
            if ( class_exists( 'woocommerce' ) ) {
                //add_action( 'acf/render_field_settings/type=number',  [ $this, 'fafe_price_field'] );
                //add_action( 'acf/render_field_settings/type=true_false',  [ $this, 'fafe_true_false_field'] );
                add_action( 'acf/render_field_settings/type=gallery', [ $this, 'fafe_gallery_field' ] );
            }
            add_filter( 'acf/get_field_types', [ $this, 'hide_fafe_fields' ] );
            add_action( 'acf/render_field_settings/type=email', [ $this, 'fafe_email_field' ] );
            add_action( 'acf/render_field_settings/type=password', [ $this, 'fafe_password_field' ] );
            add_action( 'acf/render_field_settings/type=textarea', [ $this, 'fafe_content_field' ] );
            add_action( 'acf/render_field_settings/type=wysiwyg', [ $this, 'fafe_content_field' ] );
            add_action( 'acf/render_field_settings/type=textarea', [ $this, 'fafe_excerpt_field' ] );
            add_action( 'acf/render_field_settings/type=image', [ $this, 'fafe_image_field' ] );
            //add_action( 'acf/render_field_settings/type=repeater',  [ $this, 'fafe_repeater_field'], 5 );
            //Load field value by type
            add_filter(
                'acf/load_value/type=text',
                [ $this, 'fafe_load_text_value' ],
                10,
                3
            );
            add_filter(
                'acf/load_value/type=textarea',
                [ $this, 'fafe_load_textarea_value' ],
                10,
                3
            );
            add_filter(
                'acf/load_value/type=password',
                [ $this, 'fafe_load_password_value' ],
                10,
                3
            );
            add_filter(
                'acf/load_value/type=email',
                [ $this, 'fafe_load_email_value' ],
                10,
                3
            );
            add_filter(
                'acf/load_value/type=number',
                [ $this, 'fafe_load_number_value' ],
                10,
                3
            );
            add_filter(
                'acf/load_value/type=image',
                [ $this, 'fafe_load_image_value' ],
                10,
                3
            );
            add_filter(
            ...
            add_filter(
                ...
                [ $this, 'fafe_load_taxonomy_value' ],
                9,
                3
            );
            add_filter(
                'acf/load_value/type=wysiwyg',
                [ $this, 'fafe_load_wysiwyg_value' ],
                10,
                3
            );
            add_filter(
                'acf/load_value/type=true_false',
                [ $this, 'fafe_load_truefalse_value' ],
                10,
                3
            );
            add_filter(
                'acf/load_value/type=gallery',
                [ $this, 'fafe_load_gallery_value' ],
                10,
                3
            );
            add_filter(
            ...
            add_filter(
                ...
                [ $this, 'fafe_load_user_value' ],
                10,
                3
            );
            //add_filter( 'acf/load_value/type=date_time_picker', [ $this, 'fafe_load_date_time_value'], 10, 3);
            add_filter(
                'acf/fields/relationship/result',
                [ $this, 'fafe_edit_post_button' ],
                10,
                4
            );
            add_action( 'acf/render_field/type=relationship', [ $this, 'fafe_add_post_button' ], 10 );
            add_action( 'wp_ajax_fafe/fields/relationship/add_form', [ $this, 'fafe_ajax_add_form' ] );
            add_action( 'wp_ajax_nopriv_fafe/fields/relationship/add_form', [ $this, 'fafe_ajax_add_form' ] );
            add_filter(
                'acf/fields/relationship/query',
                [ $this, 'fafe_relationship_query' ],
                10,
                3
            );
            //add_action( 'acf/render_field/type=post_object',  [ $this, 'fafe_add_post_option'], 8);
            //add_action( 'acf/render_field/type=repeater',  [ $this, 'fafe_before_repeater_field'], 8);
            //add_action( 'acf/render_field/type=repeater',  [ $this, 'fafe_after_repeater_field'], 10);
            add_action(
                'acf/save_post',
                [ $this, 'fafe_after_save_post' ],
                10,
            ...
            add_filter(
                ...
                [ $this, 'fafe_update_truefalse_value' ],
                9,
                3
            );
            add_filter(
            ...
            add_filter(
                ...
                [ $this, 'fafe_update_gallery_value' ],
                9,
                3
            );
            add_filter(
            ...
            add_filter(
                ...
                [ $this, 'fafe_update_password_value' ],
                9,
                3
            );
            add_filter(
                'acf/update_value/type=email',
                [ $this, 'fafe_update_email_value' ],
                9,
                3
            );
            add_filter(
                'acf/update_value/type=number',
                [ $this, 'fafe_update_number_value' ],
                9,
                3
            );
            add_filter(
            ...
            add_filter(
                ...
                [ $this, 'fafe_update_user_value' ],
                9,
                3
            );
            add_filter(
                'acf/update_value/type=date_time_picker',
                [ $this, 'fafe_update_date_time_value' ],
                9,
                3
            );
            //add_filter( 'acf/update_value/type=repeater', [ $this,'fafe_update_repeater_value'], 9, 3 );
            add_filter( 'acf/load_field_group', [ $this, 'fafe_exclude_groups' ] );
            add_action( 'acf/render_field/type=text', [ $this, 'fafe_render_text_field' ] );
            add_action( 'acf/render_field/type=password', [ $this, 'fafe_render_password_field' ] );
            add_action( 'acf/render_field/type=email', [ $this, 'fafe_render_email_field' ] );
            add_action( 'acf/render_field/type=select', [ $this, 'fafe_render_select_field' ] );
            add_action( 'acf/validate_save_post', [ $this, 'fafe_validation' ], 1 );
            add_action( 'acf/validate_save_post', [ $this, 'fafe_pass_validation' ], 999 );
            add_filter(
                'acf/validate_value/type=email',
                [ $this, 'fafe_validate_useremail' ],
                10,
                4
            );
            add_filter(
                'acf/validate_value/type=text',
                [ $this, 'fafe_validate_username' ],
                10,
                4
            );
            add_filter(
                'acf/validate_value/type=text',
                [ $this, 'fafe_validate_term_name' ],
                10,
                4
            );
            add_filter(
                'acf/validate_value/type=password',
                [ $this, 'fafe_validate_password' ],
                10,
                4
            );
            
            if ( defined( 'HAPPYFILES_VERSION' ) ) {
                add_action( 'acf/render_field_settings/type=image', [ $this, 'fafe_file_folders_setting' ] );
                add_action( 'acf/render_field_settings/type=file', [ $this, 'fafe_file_folders_setting' ] );
                add_action( 'acf/render_field_settings/type=gallery', [ $this, 'fafe_file_folders_setting' ] );
            ...
            require_once __DIR__ . '/forms/helpers/modal.php';
    ...
    fafe()->acf_extend = new FrontendAdmin_Hooks();
}
