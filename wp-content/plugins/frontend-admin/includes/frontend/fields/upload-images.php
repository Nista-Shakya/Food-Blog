...
class acf_field_upload_images extends acf_field {
	...
	*/
	...
	function initialize() {
		...
		$this->defaults = array(
			...
			'mime_types'	=> '',
            'insert'		=> 'append',
            'button_text'   => __( 'Add Images', 'frontend-admin' ),
		);
	...
	*/
	...
	function ajax_add_attachment() {
		...
		// validate nonce
		if( !wp_verify_nonce($args['nonce'], 'fafe_form') ) {
			wp_send_json_error();			
		} 
	...
	*/
	...
	function render_field( $field ) {
        ...
        $button_text = ( isset( $field['button_text'] ) && $field['button_text'] ) ? $field['button_text'] : __( 'Add Images', 'frontend-admin' );
