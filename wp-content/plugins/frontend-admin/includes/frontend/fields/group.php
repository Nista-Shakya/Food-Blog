...
if( ! class_exists('fafe_group_field_hooks') ) :

	class fafe_group_field_hooks {
		...
		public function __construct() {
			...
			add_action( 'acf/render_field_settings/type=group',  [ $this, 'field_settings'] );
			add_filter( 'acf/prepare_field/type=group',  [ $this, 'prepare_field'] );
		}
	}

	new fafe_group_field_hooks();
